      ...
      <div class="person_box">
        <div class="s_logo">
          <div class="school_logo">
            <div class="s_logo_bg">
              <img v-if="formMsg.headIcon" :src="formMsg.headIcon" alt="" />
  ...
  methods: {
    ...
    uploadImgToBase64(file) {
      ...
      reader.onload = function() {
        ...
        // console.log(that.formMsg.headIcon)
      };
    },
    // 初始化表单信息
    ...
    getUserInfo() {
      ...
      that.$http
        ...
        .then(res => {
          ...
          var data = res.data;
          if (data.code == 0) {
            that.formMsg.passport = data.data.passport;
            that.formMsg.phone = data.data.phone;
            that.formMsg.email = data.data.email;
    ...
    addSubmit() {
      ...
      this.formMsg.headIcon = this.formMsg.headIcon.split('base64,')[1]
      console.log(this.formMsg);
      that.$http
        .post(Url + "/aimw/teacher/addUser", this.formMsg)
        .then(res => {
          var data = res.data;
          if (data.code == 0) {
            // console.log(data);
